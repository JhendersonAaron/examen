        ...
        stage('Clone') {
            steps {
                timeout(time: 2, unit: 'MINUTES'){
                    git branch: 'main', credentialsId: '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', url: 'https://github.com/JhendersonAaron/examen.git'
                }
            }
        }
        stage('Build') {
